    ...
    return (
        <div className="">
            ...
            <div className="bg-gradient-to-t from-to-gray-main to-gray-main w-full flex items-center pl-64 text-white">
                ...
                <h1 className="pl-20 text-6xl font-bold w-1/2"><span style={{ color: "#9ff282" }}>{t("Tecnologia")}</span>, <span style={{ color: "#9ff282" }}>segurança</span> e  <span style={{ color: "#9ff282" }}>informação</span>! Esse é o blog pix<span style={{ color: "#9ff282" }}>to</span>pay</h1>
            </div>
