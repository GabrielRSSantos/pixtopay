    ...
    <div className='flex justify-center flex-col items-center'>
      ...
      <div style={{ backgroundColor: '#161815' }}
        ...
        <div className='flex flex-col justify-center'>
          <div className="">
            <h1 className='text-white text-start font-semibold text-5xl pb-5'>{t("Simplifique seus pagamentos com")} <span style={{ color: "#9ff282" }}>{t("tecnologia")}</span> {t("e")} <span style={{ color: "#9ff282" }}>{t("segurança")}</span></h1>
          </div>
            ...
            >
              {(inputProps) => (
                <input
                  ...
                  placeholder={t("Whatsapp para contato com DDD")}
                  required
                />
              )}
            </InputMask>
